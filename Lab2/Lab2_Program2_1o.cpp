...
int main(int argc, char** argv)  { 
	...
	cv::Mat procImageOut(numRows, imgD.colCount, CV_8UC3);
	...
	// Start by making ImageOut = ImageIn
	procImageOut = procImageIn.clone();
	...
	else 
	{
		...
		switch(imgD.imgProcessID){
			...
			case IMAGE_PROCESS_TYPE_BLUR:
				imageBlur(procImageIn, procImageOut, imgD.blurLvl, 0, numRows);
				os << "./blur" << rank << ".jpg";
				fileName = os.str();
